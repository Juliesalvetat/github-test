...
SaSum_file = 'magic_square_Averaged_SaSum.csv';
...
writetable(Table_SaSum,'magic_square_Averaged_SaSum.csv')

%%%%%%%%%%%%%%%%

Poly_file = 'PolyLabel_Cris.csv';
...
for i=1:length(Table_Poly.Poly_Time)
    ...
    if ~isempty(ind_ESU25)
        ...
        Table_Poly.nb_Sediment(i) = Table_SaSum.nb_Sediment(ind_ESU25);
...
writetable(Table_Poly,'PolyLabel_Cris_complete.csv')
...
%     Table_SaSum.Wind_exposure = Wind_exposure;
    ...
    writetable(Table_SaSum,'magic_square_Averaged_SaSum_Sed_complete.csv')
    
%%%%%%%%
SaSum_file = 'magic_square_Averaged_SaSum_Sed_complete.csv';
Table_SaSum = readtable(SaSum_file);

Poly_file = 'PolyLabel_Cris_complete.csv';
Table_Poly = readtable(Poly_file);
